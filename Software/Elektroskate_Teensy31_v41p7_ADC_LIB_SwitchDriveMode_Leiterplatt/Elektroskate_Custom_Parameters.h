...
#define BattSpgMMax (float) 32.7 // Maximale messbare Batterienspannung (Koeffizienten im Ausgleichspolynom muessen angepasst werden) 
...
#define Strom0A (float)    100  // 0A Messwert, wird angezeigt wenn kein Strom fliesst und Strom0A = 0 (muss kalibriert werden)
