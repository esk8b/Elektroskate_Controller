...
void setup()
{
  ...
  // ADC_0
  adc->setReference(ADC_REFERENCE::REF_EXT, ADC_0);     // Bei Extern wird die ca. 3.3V Versorgungsspannung des Teensys benutzt
  ...
  // Conversion/sampling speed can be VERY_LOW_SPEED, LOW_SPEED, MED_SPEED, HIGH_SPEED or VERY_HIGH_SPEED
  ...
  adc->setReference(ADC_REFERENCE::REF_EXT, ADC_1);     // Bei Extern wird die ca. 3.3V Versorgungsspannung des Teensys benutzt
