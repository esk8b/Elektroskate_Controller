...
12. Messung von Strom und Akkuspannung mit Bestimmung der umgesetzten Momentanleistung und Gesamtleistung
 ...
 4.1p7-09.09.2017 Barney: ADC Lib hat neue Befehlsstruktur bekommen vorher adc->setReference(ADC_REF_EXT, ADC_0); jetzt adc->setReference(ADC_REFERENCE::REF_EXT, ADC_0);                       
